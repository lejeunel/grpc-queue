...
// A Version 4 UUID is a universally unique identifier that is generated using
// random numbers.
class UUID {
public:
  ...
  std::string String() {
    ...
    std::snprintf(
        ...
        _data[7], _data[8], _data[9], _data[10], _data[11], _data[12],
        _data[13], _data[14], _data[15]);
